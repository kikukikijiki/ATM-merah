...
public class Withdrawal extends Transaction {
   private int amount; // jumlah penarikan
   ...
   private int displayMenuOfAmounts() {
      ...
      while (userChoice == 0) {
         ...
         switch (input) {
            case 1: userChoice = amounts[input]; break;
            case 2: userChoice = amounts[input]; break;
            case 3: userChoice = amounts[input]; break;
            case 4: userChoice = amounts[input]; break;
            case 5: userChoice = amounts[input]; break;// save user's choice       
